...
import typing
from rocket.stark_tech.herobraine.hero.spaces import Dict
...
from rocket.stark_tech.herobraine.hero import spaces


class EnvSpec(abc.ABC):
    U_MULTI_AGENT_ENTRYPOINT = 'rocket.stark_tech.env._multiagent:_MultiAgentEnv'
    U_FAKE_MULTI_AGENT_ENTRYPOINT = 'rocket.stark_tech.env._fake:_FakeMultiAgentEnv'
    U_SINGLE_AGENT_ENTRYPOINT = 'rocket.stark_tech.env._singleagent:_SingleAgentEnv'
    U_FAKE_SINGLE_AGENT_ENTRYPOINT = 'rocket.stark_tech.env._fake:_FakeSingleAgentEnv'
