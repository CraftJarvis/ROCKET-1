...
from rocket.stark_tech.herobraine.env_specs.simple_embodiment import SimpleEmbodimentEnvSpec
...
from rocket.stark_tech.herobraine.hero.handlers import TranslationHandler
from rocket.stark_tech.herobraine.hero.mc import ALL_ITEMS, INVERSE_KEYMAP
