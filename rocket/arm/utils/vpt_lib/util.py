...
import rocket.arm.utils.vpt_lib.torch_util as tu
from rocket.arm.utils.vpt_lib.masked_attention import MaskedAttention
from rocket.arm.utils.vpt_lib.minecraft_util import store_args
from rocket.arm.utils.vpt_lib.tree_util import tree_map
from rocket.arm.models.fusions import CrossAttentionLayer
...
class AdaLNBlock(nn.Module):
    ...
    def __init__(self, hidsize, **kwargs) -> None:
        ...
        self.adaLN_modulation = nn.Sequential(
            nn.SiLU(), 
            nn.Linear(hidsize, hidsize*2, bias=True)
        )
