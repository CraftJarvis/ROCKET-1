...
from rocket.arm.models.fusions.film import LinearFiLMLayer
from rocket.arm.utils.vpt_lib import misc
from rocket.arm.utils.vpt_lib import torch_util as tu
from rocket.arm.utils.vpt_lib.util import FanInInitReLULayer
...
class CnnBasicBlock(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if (film_kwargs := kwargs.get("film_kwargs")) is not None:
            self.film = LinearFiLMLayer(self.inchan, **film_kwargs)
        else:
            self.film = None
